...
\hypersetup{
    pdfauthor={Federico Cucino},
    pdftitle={Enhancing industrial devices: design and implementation of a security scanning tool},
    pdfsubject={University of Trento - UNITN - Master's Degree in Computer Science},
    % pdfkeywords={unitn, cybersecurity, industrial devices, scanning tool},
    colorlinks,
    citecolor=black,
    filecolor=black,
    linkcolor=black,
