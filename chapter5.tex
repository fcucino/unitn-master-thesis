...
\begin{itemize}
  \item \texttt{-s} turns off the generation of the Go symbol table;
...
\begin{lstlisting}[caption={Go tool cross-build command}, numbers=none]
...
\begin{lstlisting}[caption={Storage bucket tree of directories}, numbers=none]
  .
  |-- 0.1.0
  |   |-- linux-amd64
  |   |   |-- scantool
